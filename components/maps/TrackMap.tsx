...
const TrackMap = ({ progress, points }: TrackMapProps) => {
    ...
    useEffect(() => {
        ...
        map.on('load', () => {
            ...
            const createLocationPin = (color: string) => {
                ...
                el.innerHTML = `
                    <div class="w-full h-full rounded-none bg-gray-100 border-2 border-[${color}] flex items-center justify-center">
            ...
            pingSpan.className = 'absolute inline-flex h-full w-full rounded-none bg-[#8E24FF] opacity-75';
            
            const centerSpan = document.createElement('div');
            centerSpan.className = 'relative inline-flex rounded-none h-8 w-8 bg-gray-100 border-2 border-[#8E24FF] flex items-center justify-center p-1';
    ...
    if (tokenError) {
        return (
            <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center bg-gray-50 p-6 text-center z-10">
                <div className="w-12 h-12 bg-red-100 rounded-none flex items-center justify-center text-red-500 mb-3">
    ...
    return (
        <div className="absolute inset-0 w-full h-full">
            {/* Map Controls Panel */}
            <div className="absolute bottom-6 right-6 z-20 flex items-center gap-1 bg-gray-100 border border-gray-200 p-1.5 rounded-none">
                <button
                    onClick={() => {
                    ...
                    className="p-1.5 rounded-none text-gray-500 hover:text-[#8E24FF] hover:bg-[#8E24FF]/10 cursor-pointer group"
                ...
                <button
                    ...
                    className={`px-3 py-1.5 rounded-none text-[10px] font-extrabold uppercase cursor-pointer ${
                        style === "streets-v12"
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 md:left-[calc(50%+200px)] lg:left-[calc(50%+240px)] z-20 pointer-events-none">
                <div className="bg-gray-100 border border-gray-100 border-b-gray-200 px-6 py-2.5 rounded-none flex items-center gap-2.5">
                    <span className="w-2 h-2 rounded-none bg-[#8E24FF]" />
