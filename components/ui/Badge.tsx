...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const getStyles = () => {
    switch (variant) {
      ...
      case 'glass':
        return 'bg-white/10 text-white/90 border border-white/5 backdrop-blur-sm py-2 px-5 tracking-[0.12em]';
      case 'outline':
      ...
      case 'gray-glass':
        return 'bg-white/60 text-neutral-600 border border-neutral-200/50 backdrop-blur-sm py-2 px-5 tracking-[0.12em]';
      case 'custom':
        return '';
      case 'purple':
      default:
