  ...
  return (
    <div className="fixed inset-0 z-[100000] flex flex-col items-center justify-center bg-[#3B007A] overflow-y-auto px-6 py-12 font-sans">
      ...
      <div className="relative w-full max-w-lg bg-[#1a1028] border border-white/20 rounded-[2.5rem] p-8 md:p-12 flex flex-col items-center text-center z-10">
        ...
        <div className="relative w-32 h-20 mb-8 flex items-center justify-center">
          ...
          <div>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" className="transform rotate-[12deg] overflow-visible">
              <rect x="3" y="6" width="18" height="14" rx="2" fill="#D6FF38" />
              <rect x="2" y="3" width="20" height="4" rx="1" fill="#c6ef20" />
        ...
        {/* Text descriptions */}
        <h2 className="text-white text-2xl md:text-3xl font-extrabold tracking-tight mb-3">
          Address Not Found
        </h2>
        ...
        <Link
          href="/"
          className="bg-[#8E24FF] hover:bg-[#7a18e0] text-white text-sm font-bold px-10 py-4 rounded-full group flex items-center gap-2 transition-colors"
        >
