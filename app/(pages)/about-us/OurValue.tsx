...
const OurValue = () => {
  const values = [
    {
      id: 1,
      image: images.ourValue1,
      title: "Speed"
    },
    {
      id: 2,
      image: images.ourValue2,
      title: "Trust"
    },
    {
      id: 3,
      image: images.ourValue3,
      title: "Reliability"
    },
    {
      id: 4,
      image: images.ourValue4,
      title: "Growth"
    }
  ];
  ...
  const xRaw = useTransform(scrollYProgress, [0, 1], [0, xTranslation]);
  const x = useSpring(xRaw, { damping: 20, stiffness: 90, mass: 0.8 });

  return (
    <section ref={targetRef} className="relative w-full bg-[#F4E9FF] h-auto md:h-[200vh] lg:h-[250vh] xl:h-[300vh]">
      <div className="relative md:sticky md:top-0 h-auto md:h-screen w-full flex flex-col justify-start md:pt-[12vh] lg:pt-[15vh] overflow-visible md:overflow-hidden pt-14 pb-6 sm:py-20 md:py-0">
        ...
        {/* Desktop View: Horizontal Animated Cards Wrapper */}
        ...
        {/* Mobile View: Vertical Cards Wrapper */}
