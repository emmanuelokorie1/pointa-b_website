        ...
        <div>
            ...
            <section className="relative w-full bg-[#5B0097] pt-32 md:pt-40 pb-44 md:pb-60 px-6 sm:px-8 overflow-hidden z-0">
                ...
                <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
                    {/* Page Badge */}
                    <Badge text="ABOUT US" variant="glass" className="mb-6" />

                    {/* Heading */}
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold tracking-tight leading-[1.15] mb-6">
                        We are A2B-Moving what matters
                    </h1>

                    {/* Paragraph Description */}
                    <p className="text-white/85 text-base md:text-lg lg:text-xl font-medium max-w-4xl leading-relaxed tracking-wide">
                        A2B Logistics was born out of a simple frustration, deliveries in Nigeria were too slow, too unreliable and too stressful.
                        We decided to fix that. Today we are one of the fastest growing logistics and delivery platforms in the country,
                        connecting customers, merchants and riders in one seamless ecosystem that just works.
                    </p>
                </div>
            </section>

            {/* Staggered Masonry Grid Section */}
            <section className="relative z-10 px-6 sm:px-8 lg:px-12 xl:px-16 max-w-[1400px] mx-auto w-full -mt-24 md:-mt-36 lg:-mt-44 mb-24">
                <div className="relative w-full aspect-[1305/651] overflow-hidden group" style={{ position: 'relative' }}>
                    ...
                    <Image
                        ...
                        alt="Point A2B Team collaboration"
                        fill
