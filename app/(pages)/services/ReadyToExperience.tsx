...
const ReadyToExperience = () => {
  ...
  return (
    <section className="w-full bg-[#F4E9FF] py-14 sm:py-20 px-4 sm:px-[10px] select-none font-sans">
      <div className="w-full bg-primary sm:w-[85%] mx-auto rounded-[2.5rem] py-16 sm:py-20 px-6 sm:px-12 md:px-20 flex flex-col items-center justify-center text-center relative overflow-hidden">

        {/* 3 Overlapping Avatars */}
        <div className="flex -space-x-3 items-center justify-center mb-6 relative z-10">
          {avatars.map((avatar, idx) => (
            <div
              className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white/20"
            >
              <Image
                src={avatar}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10 w-full">
          ...
          <a
            className="w-full sm:w-auto bg-[#F4F4F5] text-primary font-bold px-6 py-4 rounded-full text-sm sm:text-base flex items-center justify-center"
          >
          ...
          <a
            className="w-full sm:w-auto bg-primary hover:bg-white/15 border border-white/20 text-white font-bold px-5 py-4 rounded-full text-sm sm:text-base flex items-center justify-center gap-3"
          >
